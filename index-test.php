...
<html>
 <head>
    ...
    <link rel="stylesheet" type="text/css" href="dynamicoutput.css.php?get_css" />
...
<body>
    <div class="content">
		<h1 id="mobile">Мобильная версия сайта</h1>
		<h1 id="desctop">Полная версия сайта</h1>
	...
	<!-- dynamic.css -->
			<a href="dynamicoutput.css.php?user_choice" id="dynamic_css"></a>
			<script src="dynamicoutput.css.php?get_js"></script>
	<!-- end dynamic.css -->	
